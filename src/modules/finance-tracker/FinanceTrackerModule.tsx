    ...
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Controla tu salud financiera: ahorros, inversiones y préstamos.
          </p>
        </div>
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="bg-card text-card-foreground p-8 rounded-2xl border border-border shadow-sm">
          ...
          <p className="text-3xl font-bold">8.900,00 €</p>
        </div>
      </div>
        ...
        <div className="bg-card text-card-foreground rounded-2xl border border-border overflow-hidden shadow-sm">
          ...
          <div className="divide-y">
            {[
              ...
              <div
                key={i}
                className="p-6 flex justify-between items-center hover:bg-muted transition"
              >
                <div>
                ...
                <p
                  className={`font-bold ${item.amount.startsWith("+") ? "text-green-600" : ""}`}
                >
                  {item.amount}
                </p>
              </div>
