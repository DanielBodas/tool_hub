...
export default async function DashboardPage() {
  ...
  const tools = allTools.filter(tool => isToolAllowed(tool.id, session));
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      {tools.length === 0 ? (
        <div className="bg-muted p-12 rounded-3xl text-center">
          <p className="text-xl font-medium text-muted-foreground">
            No tienes acceso a ninguna herramienta.
          </p>
      ...
      <div className="mt-12 p-6 rounded-2xl border-2 border-dashed border-border flex flex-col items-center justify-center text-center">
